...
import pandas as pd
from ufm_sdk_tools.src.netfix.netfix_utils import read_and_preprocessing_file, add_partner_info, add_link_hash_id
...
def get_link_flapping(prev_counters_csv, cur_counters_csv):
    ...
    try:
        ...
        # remove duplicated links flapping records:
        linkdown_df1.drop_duplicates(
            subset=['link_hash_id'],
            keep='first',
            inplace=True
        )
